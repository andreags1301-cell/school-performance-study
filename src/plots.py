"""Figures for the school value-added analysis.

Reproduces the report figures and creates one README figure:
  * Figure 1 - Model 1 vs Model 3 school ranks.
  * Figure 2 - Model 3 vs Model 4 school ranks.
  * README figure - estimator effect vs composition effect in one 2x2 plot.
...
def _rank_panel(ax, df, x, y, title, xlab, ylab, note=None):
...
def readme_rank_comparison_figure(effects, path):
    """Main README figure: estimator effect vs composition effect."""
    ...
    panels = [
        ...
        },
        {
            ...
            "x": "rank_hlm_simple",
            "y": "rank_hlm_context",
            "title": "Mathematics: before vs after composition",
            "xlab": "M3 rank",
            "ylab": "M4 rank",
            "note": "Spearman = 0.620",
        },
        ...
        },
        {
            ...
            "x": "rank_hlm_simple",
            "y": "rank_hlm_context",
            "title": "Language: before vs after composition",
            "xlab": "M3 rank",
            "ylab": "M4 rank",
            "note": "Spearman = 0.607",
        },
    ...
    fig.suptitle(
        "School ranking stability: estimator effect vs composition effect",
        fontsize=13,
        fontweight="bold",
    )
    fig.tight_layout()
...
def math_language_figure(effects, path):
    ...
    ax.set(
        title="Mathematics and Language value-added (Model 4)",
        xlabel="Mathematics VA (Model 4)",
        ylabel="Language VA (Model 4)",
    )
    ax.grid(True, alpha=0.25)
...
def save_all(samples, results, figures_dir=config.FIGURES_DIR, assets_dir=config.ASSETS_DIR):
    ...
    saved.append(
        readme_rank_comparison_figure(
            effects,
            assets_dir / "readme_rank_comparison.png",
        )
    )
